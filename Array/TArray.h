...
{
	template<typename T>
	class INTEGRIAN2D_API Array final
	{
	...
	#pragma region Ctors and Dtor
		constexpr Array()
			...
			, m_pCurrentEnd{}
		{}
		constexpr explicit Array(const Size_P size)
			: m_pHead{}
			, m_pTail{}
			, m_pCurrentEnd{}
		{
		...
		constexpr explicit Array(const Capacity_P cap)
			: m_pHead{}
			, m_pTail{}
			, m_pCurrentEnd{}
		{
		...
		constexpr explicit Array(std::initializer_list<T> init)
			: m_pHead{}
			, m_pTail{}
			, m_pCurrentEnd{}
		{
